/* Maître Hibou V25.8.09 — contenu Lecture P1 */
(function(){
'use strict';
...
window.HIBOU_LEARNING_ACTIVITIES['LEC-P1-01']={
  ...
  lesson:{
    ...
    example:{word:'phacochère',chunks:['pha','co','chè','re'],sentence:'Au zoo, nous observons un phacochère.'}
  },
  guided:[
    {id:'g1',type:'order',title:'Je reconstruis le mot',prompt:'Remets les morceaux dans le bon ordre pour former « phacochère ».',items:['chè','pha','re','co'],answer:['pha','co','chè','re'],help:['Commence par le morceau « pha ».','Après « pha », on entend « co ».','La fin du mot est « chè - re ».'],feedback:'Très bien : pha - co - chè - re.'},
  ...
  training:[
    ...
    {id:'t2',type:'order',title:'Je rassemble les morceaux',prompt:'Remets les morceaux dans l’ordre pour former « mystérieux ».',items:['rieux','mys','té'],answer:['mys','té','rieux'],help:['Le mot commence par « mys ».','Le milieu est « té ».','La fin est « rieux ».'],feedback:'Oui : mys - té - rieux.'},
  ...
  challenge:[
    {id:'c1',type:'order',title:'Mon défi 1',prompt:'Sans aide : remets les morceaux dans l’ordre pour former « extraordinaire ».',items:['naire','ex','tra','or','di'],answer:['ex','tra','or','di','naire'],feedback:'Bravo ! Tu as reconstruit un mot long sans aide.'},
