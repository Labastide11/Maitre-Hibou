...
/* Maître Hibou V25.8.03 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25803) return;
  window.__hibouQuestionModalV25803 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.03';
    document.title = '🦉 Maître Hibou V25.8.03';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25803';
  ...
  window.openStudentQuestionModalV25803 = openModal;
  window.closeStudentQuestionModalV25803 = closeModal;
})();
