...
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25793) return;
  window.__hibouQuestionModalV25793 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.7.93';
    document.title = '🦉 Maître Hibou V25.7.93';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25793';
  ...
  window.openStudentQuestionModalV25793 = openModal;
  window.closeStudentQuestionModalV25793 = closeModal;
})();
