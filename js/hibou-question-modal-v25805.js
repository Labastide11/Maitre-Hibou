...
/* Maître Hibou V25.8.05 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25805) return;
  window.__hibouQuestionModalV25805 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.05';
    document.title = '🦉 Maître Hibou V25.8.05';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25805';
  ...
  window.openStudentQuestionModalV25805 = openModal;
  window.closeStudentQuestionModalV25805 = closeModal;
})();
