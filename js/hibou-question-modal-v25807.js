...
/* Maître Hibou V25.8.07 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25807) return;
  window.__hibouQuestionModalV25807 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.07';
    document.title = '🦉 Maître Hibou V25.8.07';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25807';
  ...
  window.openStudentQuestionModalV25807 = openModal;
  window.closeStudentQuestionModalV25807 = closeModal;
})();
