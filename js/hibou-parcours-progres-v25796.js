/* Maître Hibou V25.7.96 — Ceintures illustrées dans Mon parcours et mes progrès */
(function(){
'use strict';if(window.__hibouProgressHubV25796)return;window.__hibouProgressHubV25796=true;
var VERSION='🦉 Maître Hibou V25.7.96',latestSnapshot=null,overlay=null,quoteIndex=-1,activeTab='recent',recentExpanded=false,classRecords=null,classRecordsLoading=false;
...
var QUESTION_STORE_V25796='hibou_student_questions_v25796';
...
function readStoredQuestions(){
  try{
    var rows=JSON.parse(localStorage.getItem(QUESTION_STORE_V25796)||'[]');
...
function writeStoredQuestion(payload){
  ...
  try{
    ...
    rows.unshift(row);
    localStorage.setItem(QUESTION_STORE_V25796,JSON.stringify(rows.slice(0,40)));
  }catch(e){}
}
...
window.openHibouProgressHubV25796=open;window.closeHibouProgressHubV25796=close;window.openHibouProgressHubV25791=open;window.closeHibouProgressHubV25791=close;
