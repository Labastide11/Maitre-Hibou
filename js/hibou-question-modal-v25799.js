...
/* Maître Hibou V25.7.99 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25799) return;
  window.__hibouQuestionModalV25799 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.7.99';
    document.title = '🦉 Maître Hibou V25.7.99';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25799';
  ...
  window.openStudentQuestionModalV25799 = openModal;
  window.closeStudentQuestionModalV25799 = closeModal;
})();
