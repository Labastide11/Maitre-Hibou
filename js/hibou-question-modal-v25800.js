...
/* Maître Hibou V25.8.00 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25800) return;
  window.__hibouQuestionModalV25800 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.00';
    document.title = '🦉 Maître Hibou V25.8.00';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25800';
  ...
  window.openStudentQuestionModalV25800 = openModal;
  window.closeStudentQuestionModalV25800 = closeModal;
})();
