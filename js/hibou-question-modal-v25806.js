...
/* Maître Hibou V25.8.06 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25806) return;
  window.__hibouQuestionModalV25806 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.06';
    document.title = '🦉 Maître Hibou V25.8.06';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25806';
  ...
  window.openStudentQuestionModalV25806 = openModal;
  window.closeStudentQuestionModalV25806 = closeModal;
})();
