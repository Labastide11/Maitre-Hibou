...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25802) return;
  window.__hibouBottomNavV25802 = true;
  ...
  function build(){
    ...
    if(bar.dataset.owner === 'v25802' && expected === 6) return true;

    bar.dataset.owner = 'v25802';
    bar.classList.remove('hibou-bottom-nav-v25778');
    bar.classList.add('hibou-bottom-nav-v25802');
  ...
  /* Garantit que la version affichée reste V25.8.02 après les autres modules. */
