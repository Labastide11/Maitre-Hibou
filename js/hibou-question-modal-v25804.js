...
/* Maître Hibou V25.8.04 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25804) return;
  window.__hibouQuestionModalV25804 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.04';
    document.title = '🦉 Maître Hibou V25.8.04';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25804';
  ...
  window.openStudentQuestionModalV25804 = openModal;
  window.closeStudentQuestionModalV25804 = closeModal;
})();
