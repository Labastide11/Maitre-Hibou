/* Maître Hibou V25.7.94 — Ceintures illustrées dans Mon parcours et mes progrès */
(function(){
'use strict';if(window.__hibouProgressHubV25794)return;window.__hibouProgressHubV25794=true;
var VERSION='🦉 Maître Hibou V25.7.94',latestSnapshot=null,overlay=null,quoteIndex=-1,activeTab='recent',recentExpanded=false,classRecords=null,classRecordsLoading=false;
...
function renderPanel(k){var p=document.querySelector('.hp79-panel');if(!p)return;p.classList.toggle('hp91-recent-panel',k==='recent');p.innerHTML=panelContent(k);var m=p.querySelector('[data-hp79-more]');if(m)m.addEventListener('click',function(){recentExpanded=!recentExpanded;renderPanel('recent')})}
...
window.openHibouProgressHubV25794=open;window.closeHibouProgressHubV25794=close;window.openHibouProgressHubV25791=open;window.closeHibouProgressHubV25791=close;
