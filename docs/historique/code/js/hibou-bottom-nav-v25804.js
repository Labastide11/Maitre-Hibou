...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25804EightIcons) return;
  window.__hibouBottomNavV25804EightIcons = true;
  ...
  function replaceSubject(btn,key){
    ...
    btn.setAttribute('data-hibou-icon-version','25804');
    return true;
  }
  ...
  function applyBottomBar(){
    ...
    if(count===8) bar.setAttribute('data-hibou-icons','25804-eight');
    return count;
  }
  ...
  window.hibouRefreshBottomIconsV25804=apply;
})();
