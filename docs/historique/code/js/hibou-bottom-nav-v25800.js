...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25800) return;
  window.__hibouBottomNavV25800 = true;
  ...
  function build(){
    ...
    if(bar.dataset.owner === 'v25800' && expected === 6) return true;

    bar.dataset.owner = 'v25800';
    bar.classList.remove('hibou-bottom-nav-v25778');
    bar.classList.add('hibou-bottom-nav-v25800');
  ...
  /* Garantit que la version affichée reste V25.8.00 après les autres modules. */
