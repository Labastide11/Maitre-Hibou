...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25798) return;
  window.__hibouBottomNavV25798 = true;
  ...
  function build(){
    ...
    if(bar.dataset.owner === 'v25798' && expected === 6) return true;

    bar.dataset.owner = 'v25798';
    bar.classList.remove('hibou-bottom-nav-v25778');
    bar.classList.add('hibou-bottom-nav-v25798');
  ...
  /* Garantit que la version affichée reste V25.7.98 après les autres modules. */
