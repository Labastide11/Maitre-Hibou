...
/* Maître Hibou V25.8.01 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25801) return;
  window.__hibouQuestionModalV25801 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.8.01';
    document.title = '🦉 Maître Hibou V25.8.01';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25801';
  ...
  window.openStudentQuestionModalV25801 = openModal;
  window.closeStudentQuestionModalV25801 = closeModal;
})();
