...
/* Maître Hibou V25.7.98 — Boîte à questions en popup intégrée */
(function(){
  'use strict';
  if(window.__hibouQuestionModalV25798) return;
  window.__hibouQuestionModalV25798 = true;

  try{
    window.MAITRE_HIBOU_VERSION = 'V25.7.98';
    document.title = '🦉 Maître Hibou V25.7.98';
  }catch(e){}
  ...
  function ensureModal(){
    ...
    modal.id = 'hibouQuestionModalV25798';
  ...
  window.openStudentQuestionModalV25798 = openModal;
  window.closeStudentQuestionModalV25798 = closeModal;
})();
