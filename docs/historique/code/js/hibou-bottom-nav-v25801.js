...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25801) return;
  window.__hibouBottomNavV25801 = true;
  ...
  function build(){
    ...
    if(bar.dataset.owner === 'v25801' && expected === 6) return true;

    bar.dataset.owner = 'v25801';
    bar.classList.remove('hibou-bottom-nav-v25778');
    bar.classList.add('hibou-bottom-nav-v25801');
  ...
  /* Garantit que la version affichée reste V25.8.01 après les autres modules. */
