...
(function(){
  'use strict';
  if(window.__hibouBottomNavV25795) return;
  window.__hibouBottomNavV25795 = true;
  ...
  function build(){
    ...
    if(!bar) return false;
    if(bar.dataset.owner === 'v25795') return true;

    bar.dataset.owner = 'v25795';
    bar.classList.remove('hibou-bottom-nav-v25778');
    bar.classList.add('hibou-bottom-nav-v25795');
  ...
  /* Garantit que la version affichée reste V25.7.95 après les autres modules. */
