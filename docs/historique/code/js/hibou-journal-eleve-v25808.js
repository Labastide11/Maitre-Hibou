/*
 * Maître Hibou V25.8.08 — Journal élève consolidé
...
(function(){
  'use strict';
  if(window.__hibouStudentSystemV25808) return;
  window.__hibouStudentSystemV25808=true;

  var VERSION='V25.8.08';
  ...
  window.hibouTrackLearningActivity=trackLearningActivity;window.hibouStudentSystem={version:VERSION,track:track,trackLearningActivity:trackLearningActivity,success:recordSuccess,error:recordError,currentName:currentName,getHistory:getHistory,getLast:getLast,loadSnapshot:loadSnapshot,refresh:refreshStudent,configured:configured,config:config};
